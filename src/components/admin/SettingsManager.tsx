...
import { Save, Settings, Phone, Mail, MapPin, Instagram, Facebook, Youtube, Globe } from 'lucide-react';
...
export default function SettingsManager() {
  ...
  const handleSaveContact = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Simpan ke Firestore koleksi 'settings' doc 'contact'
  ...
  const handleSaveSocial = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Simpan ke Firestore koleksi 'settings' doc 'social'
    setSavedSocial(true);
