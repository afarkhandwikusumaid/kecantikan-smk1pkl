...
let nextId = 1;
const initialData: Achievement[] = [
  { id: String(nextId++), studentName: 'Putri Ayu Lestari', type: 'Lomba Tata Rias', level: 'Provinsi', year: '2024', description: 'Juara 1 LKS Tata Kecantikan Kulit Jawa Tengah 2024' },
  { id: String(nextId++), studentName: 'Nazwa Ramadanti', type: 'Lomba Perawatan Rambut', level: 'Kota/Kab', description: 'Juara 2 Lomba Kecantikan Kota Pekalongan', year: '2024' },
];

const emptyForm = { studentName: '', type: '', level: 'Kota/Kab' as Achievement['level'], year: new Date().getFullYear().toString(), description: '' };
...
export default function AchievementManager() {
  ...
  const openEdit = (a: Achievement) => { setEditingId(a.id); setFormData({ studentName: a.studentName, type: a.type, level: a.level, year: a.year, description: a.description }); setShowModal(true); };
