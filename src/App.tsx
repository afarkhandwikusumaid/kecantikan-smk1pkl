            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
              ...
              <div className="flex justify-center gap-4 pt-4">
                <button
                  ...
                  className={`px-6 py-2.5 rounded-full text-sm font-bold uppercase tracking-wider transition-all duration-300 border cursor-pointer ${
              ...
              >
                ...
                <div className="overflow-y-auto p-0">
                  ...
                  <div className="p-8 sm:p-10 space-y-6">
                    ...
                    <div className="bg-pink-50/50 border border-pink-100 p-4 rounded-2xl flex items-center space-x-3.5 text-xs text-pink-705 text-pink-700 leading-relaxed">
